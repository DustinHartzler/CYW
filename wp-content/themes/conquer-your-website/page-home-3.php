<?php 
/*
* Template Name: Home Page w/ Video #3
*/
?>
...
<iframe src="http://fast.wistia.net/embed/iframe/q3ydwzhglj?controlsVisibleOnLoad=true&version=v1&videoHeight=360&videoWidth=640&volumeControl=true&videoFoam=true" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" width="640" height="360"></iframe>
<script src='//fast.wistia.com/static/iframe-api-v1.js'></script>       
        </div>
<ul class="video-series-nav">
                ...
                <li><a class="active" href="http://conqueryourwebsite.com/video-5-rookie-mistakes-to-leave-your-site-vulnerable-to-attacks/">Rookie Mistakes</a></li>
                <li><a class="active" href="http://conqueryourwebsite.com/video-6-new-features-in-wordpress-3-6/">The Tools!</a></li>
