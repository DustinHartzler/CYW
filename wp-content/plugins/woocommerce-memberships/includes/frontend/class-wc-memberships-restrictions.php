...
class WC_Memberships_Restrictions {
	...
	/** @var associative array of content conditions for current user **/
...
/**
	...
	public function exclude_restricted_posts( WP_Query $wp_query ) {
		...
		else if ( 'yes' == get_option( 'wc_memberships_hide_restricted_products' ) && 'product_query' == $wp_query->get( 'wc_query' ) ) {
	 ...
	 * @param $match_type string|array Optional. Post type / taxonomy or array of post types or taxonomies to get object IDs for, if empty, will return all object IDs
	 ...
	 *
	 * @since 1.0.0
	 * @param array $rules Array of taxonomies
	 * @return string
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @param array $rules Array of term IDs
	 * @param string $query_type Optional. Query type. One of 'posts' or 'taxonomies'. Defaults to 'posts'.
	 * @return string
	 */
