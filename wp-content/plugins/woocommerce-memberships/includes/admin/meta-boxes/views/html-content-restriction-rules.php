	...
	<thead>
		<tr>
			<th class="check-column">
				<input type="checkbox" id="content-restriction-rules-select-all">
				<label for="content-restriction-rules-select-all"> <?php esc_html_e( "Select all", WC_Memberships::TEXT_DOMAIN ); ?></label>
			</th>
			...
			<th class="content-restriction-access-schedule">
				...
				<img class="help_tip" data-tip='<?php esc_attr_e( 'When will members gain access to content?', WC_Memberships::TEXT_DOMAIN ) ?>' src="<?php echo esc_url( WC()->plugin_url() ); ?>/assets/images/help.png" height="16" width="16" />
			</th>
	...
	<tfoot>
		<tr>
			<th colspan="<?php echo ( 'wc_membership_plan' == $post->post_type ) ? 4 : 3; ?>">
				...
				<button type="button" class="button button-secondary remove-rules js-remove-rules <?php if ( count( $content_restriction_rules ) < 2 ) : ?>hide<?php endif; ?>"><?php esc_html_e( 'Delete Selected', WC_Memberships::TEXT_DOMAIN ); ?></button>
			</th>
		</tr>
	</tfoot>
